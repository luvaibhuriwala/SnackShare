                           ...
                           <form action="<?php echo e(route('register')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                              ...
                              <p class="mt-3 text-center">
                                 Already have an account? <a href="<?php echo e(route('login.show')); ?>" class="text-underline">Sign in.</a>
                              </p>
                           </form>
                        </div>
                     </div>
...
<?php /**PATH C:\Users\luvai\Desktop\Uni Stuff\5th Semester\CSC2126 Software Construction and Development\Final Project\SnackShare_2212290\resources\views/register.blade.php ENDPATH**/ ?>
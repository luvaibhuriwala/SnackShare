    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="{{ route('index') }}" class="navbar-brand">
                ...
                <!--Logo start-->
                <div class="logo-main">
                    <img src="{{ asset('images/snackshare.png') }}" alt="logo" style="width: 50px; height: auto">
                </div>
                <!--logo End-->
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('items.create') }}">
                            <span class="item-name">Share</span>
                        </a>
                    </li><br>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ route('requests.index') }}">
        ...
        <form action="{{ route('logout') }}" method="POST" style="display: inline; align-items:center">
            @csrf
    ...
    <main class="main-content">
      <div class="position-relative iq-banner">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                ...
                <li class="nav-item dropdown">
                  <div class="py-0 nav-link d-flex align-items-center">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">@yield('fullName')</h6>
                        <p class="mb-0 caption-sub-title">@yield('institute')</p>
                    </div>
                </div>
                </li>
              </ul>
          ...
          <div class="iq-navbar-header" style="height: 215px; background-image: url({{ asset('images/dashboard/top-header.png') }}); background-size: cover; background-position: center;">
